...
export const POSTER_CATEGORY: ProjectCategory = {
  id: "poster-design",
  title: "Poster Design",
  subtitle:
    "A curated archive of social campaigns, promotional key visuals and editorial poster systems across technology, education, food and lifestyle brands.",
  projects: [
    {
      id: "stealth-in-motion",
      title: "Stealth in Motion",
    ...
    {
      id: "crawl-heavy-sites",
      title: "Crawl Heavy Sites",
      type: "Product Campaign",
      year: "2026",
      client: "9Proxy",
      role: "Graphic Designer",
    ...
    {
      id: "lunar-deal-reseller",
      title: "Lunar Deal for Resellers",
    ...
    {
      id: "lunar-new-year-proxy",
      title: "Lunar New Year Proxy",
      type: "Seasonal Campaign",
      year: "2026",
      client: "9Proxy",
      role: "Graphic Designer",
    ...
    {
      id: "black-friday-bonus-wheel",
      title: "Black Friday Bonus Wheel",
      type: "Black Friday Campaign",
      year: "2026",
      client: "9Proxy",
      role: "Graphic Designer",
      tools: ["Photoshop", "Illustrator"],
    ...
    {
      id: "proxy-email-campaign",
      title: "Proxy Email Campaign",
      type: "Email Campaign",
      year: "2026",
      client: "9Proxy",
      role: "Graphic Designer",
      ...
      groups: [
        {
          id: "set-up-in-one-minute",
          label: "Set Up in One Minute",
          layout: "single",
          images: [
            {
    ...
    {
      id: "proxy-performance-journey",
      title: "Proxy Performance Journey",
      type: "Brand Visual",
      year: "2026",
      client: "9Proxy",
      role: "Graphic Designer",
    ...
    {
      id: "rocket-through-barriers",
      title: "Rocket Through Barriers",
      type: "Product Campaign",
      year: "2026",
      client: "BeeProxy",
      role: "Graphic Designer",
    ...
    {
      id: "perfect-proxy-match",
      title: "The Perfect Proxy Match",
      type: "Engagement Campaign",
      year: "2026",
      client: "BeeProxy",
      role: "Graphic Designer",
    ...
    {
      id: "born-later-built-better",
      title: "Born Later, Built Better",
      type: "Brand Campaign",
      year: "2026",
      client: "BeeProxy",
      role: "Graphic Designer",
    ...
    {
      id: "real-speed-real-results",
      title: "Real Speed, Real Results",
    ...
    {
      id: "more-you-pour-more-you-score",
      title: "More You Pour, More You Score",
    ...
    {
      id: "welcome-to-9proxy",
      title: "Welcome to 9Proxy",
    ...
    {
      id: "express-yourself-editorial",
      title: "Express Yourself",
      type: "Editorial Poster Series",
      year: "2026",
      client: "Personal Project",
      role: "Graphic Designer",
      tools: ["Photoshop", "Illustrator"],
    ...
    {
      id: "aidi-ai-learning-campaign",
      title: "AI Learning Campaign",
    ...
    {
      id: "tho-phat-mini-bao-campaign",
      title: "Thọ Phát Mini Bao Campaign",
      type: "Social Campaign",
      year: "2026",
      client: "Thọ Phát × KIDO Group",
      role: "Graphic Designer",
      tools: ["Photoshop", "AI Image Workflow"],
      thumbnail:
        "/projects/poster/tho-phat-mini-bao-campaign/weekend-chill.webp",
      description:
        "A playful social campaign using a 3D chef mascot and everyday lifestyle moments to position Mini Bao as a convenient companion throughout the day.",
      groups: [
        {
          id: "weekend-chill",
          label: "Weekend Chill",
          ...
          images: [
            {
              src: "/projects/poster/tho-phat-mini-bao-campaign/weekend-chill.webp",
              alt: "Thọ Phát Mini Bao Campaign — Weekend Chill",
            },
          ],
        },
        {
          ...
          images: [
            {
              src: "/projects/poster/tho-phat-mini-bao-campaign/product-launch.webp",
              alt: "Thọ Phát Mini Bao Campaign — Product Launch",
            },
          ],
        },
        {
          ...
          images: [
            {
              src: "/projects/poster/tho-phat-mini-bao-campaign/back-to-campus.webp",
              alt: "Thọ Phát Mini Bao Campaign — Back to Campus",
            },
          ],
        },
        {
          ...
          images: [
            {
              src: "/projects/poster/tho-phat-mini-bao-campaign/newsroom.webp",
              alt: "Thọ Phát Mini Bao Campaign — Newsroom",
            },
          ],
        },
        {
          id: "morning-rescue",
          label: "Morning Rescue",
          layout: "single",
          images: [
            {
              src: "/projects/poster/tho-phat-mini-bao-campaign/morning-rescue.webp",
              alt: "Thọ Phát Mini Bao Campaign — Morning Rescue",
            },
          ],
        },
        {
          ...
          images: [
            {
              src: "/projects/poster/tho-phat-mini-bao-campaign/lunch-break.webp",
              alt: "Thọ Phát Mini Bao Campaign — Lunch Break",
            },
          ],
        },
      ],
